...
//           <img onClick={() => router.push('/')}  src="logo.png" className="w-8 mb-1" />
//         <ul>
...
//               Apple Event
//             </h1>
//             <h1 className="text-white text-3xl">Watch online on 9/9 at 10 a.m.P.T</h1>
//             <button className="w-[170px] h-[50px] rounded-full bg-white text-lg">Add to calendar</button>
//           </div>
//         </div>
//       </div>
//     </div>
